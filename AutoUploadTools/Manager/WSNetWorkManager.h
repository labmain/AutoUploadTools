...
@property (nonatomic, strong) NSNumber *buildType; //buildType    Integer    应用类型（1:iOS; 2:Android）
@property (nonatomic, strong) NSNumber *buildIsFirst; //buildIsFirst    Integer    是否是第一个App（1:是; 2:否）
@property (nonatomic, strong) NSNumber *buildIsLastest; //buildIsLastest    Integer    是否是最新版（1:是; 2:否）
@property (nonatomic, strong) NSNumber *buildFileSize; //buildFileSize    Integer    App 文件大小
...
@property (nonatomic, strong) NSNumber *buildBuildVersion; //buildBuildVersion    Integer    蒲公英生成的用于区分历史版本的build号
